...
nexttile;
scrambled_image = primeAlgorithmStraightRows(original_image, permutation_key);
imshow(uint8(scrambled_image)); % Display the scrambled image
imwrite(scrambled_image, "saved_images/Prime_rows.jpg")
nexttile;

unscrambled_image = primeAlgorithmReverseRows(scrambled_image, 123456);
